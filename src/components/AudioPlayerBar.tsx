...
export function AudioPlayerBar({ audio, surah }: AudioPlayerBarProps) {
  ...
  return (
    <div
      className="fixed inset-x-0 bottom-0 z-40 border-t border-border bg-base/95 backdrop-blur"
      role="region"
    ...
    >
      <div className="mx-auto flex h-16 w-full max-w-3xl items-center gap-3 px-4">
        ...
        <button
          ...
          className="motion-fade flex h-9 w-9 items-center justify-center rounded-md border border-border text-muted hover:text-text disabled:opacity-40"
        >
        ...
        <button
          ...
          className="motion-fade flex h-9 w-9 items-center justify-center rounded-md border border-border text-muted hover:text-text"
        >
          <svg
            width="14"
            height="14"
        ...
        <label className="ml-1 flex items-center gap-1.5 text-xs text-muted select-none">
          <input
            type="checkbox"
            checked={autoAdvance}
